...
<div class="header">
	<div class="container">
		<div class="header-main">
			   <div class="head-left">
				   	<div class="phone">
				   		<p>Phone<span class="ph-numb">+55 (64) 96115-8547</span></p>
				   	</div>
				   	<div class="search">		
...
<div class="top-navg-main">
	<div class="container">
	    <div class="top-navg">
				...
				<ul class="res">
				    <li><a href="<?php echo elgg_get_site_url();?>#main" class="active hvr-sweep-to-bottom">Home</a></li> 
					<li><a class="hvr-sweep-to-bottom" href="<?php echo elgg_get_site_url();?>/bookmarks#main">Bookmarks</a></li> 
					<li><a class="hvr-sweep-to-bottom" href="<?php echo elgg_get_site_url();?>/blog#main">Blogs</a></li> 
					<li><a class="hvr-sweep-to-bottom" href="<?php echo elgg_get_site_url();?>/pages/all#main">Pages</a></li>
					<li><a class="hvr-sweep-to-bottom" href="<?php echo elgg_get_site_url();?>/thewire#main">Wire posts</a></li> 
					<li><a class="hvr-sweep-to-bottom" href="<?php echo elgg_get_site_url();?>/file#main">Files</a></li> 
					<li><a class="hvr-sweep-to-bottom" href="<?php echo elgg_get_site_url();?>/members#main">Members</a></li>
				 </ul>
					<!-- script-for-menu -->
						 <script>
...
<div class="footer">
	<div class="container">
		<div class="footer-main">			  
			...
			<p>© 2016 MySite.com All Rights Reserved. </p>
		   </div>
		</div>
	</div>
</div>
