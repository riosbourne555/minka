            ...
            <div class="container home-container">
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8">
                        <div class="home_text">
                            <!-- TITLE AND DESC -->
                            <h1>Explore. Share. Innovate</h1>
                            <p>A perfect and clean design for your social network</br>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>

                            <div class="download-btn">
                            <!-- BUTTON -->
                                <a class="btn home-btn wow fadeInLeft" href="javascript:void(0)" onclick = "document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'">Sign in</a>
                               
			        <a class="tuor btn wow fadeInRight" href="/register">Open an account?</a>
                            </div>
                        </div>
                    </div>
